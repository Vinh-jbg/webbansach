<?php
    class ImportDetailModel extends BaseModel{
        ...
        public function getByImportID($importId) {
            ...
            $sql = "SELECT * FROM ".self::TABLE." where MaPN = $importId";
            return $this->getByQuery($sql);
        }

        public function getByIDPI($importId, $productID) {

            $sql = "SELECT * FROM ".self::TABLE." where MaPN = $importId and MaSP = $productID";
            return $this->getByQuery($sql);
        }
